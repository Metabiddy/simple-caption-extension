/** @typedef {'SUBTITLE_LOAD'|'SUBTITLE_CLEAR'|'SUBTITLE_SEEK'|'SUBTITLE_SET_OFFSET'|'SUBTITLE_SET_BILIBILI_MODE'|'SUBTITLE_GET_STATE'|'SUBTITLE_STATUS'|'SUBTITLE_STATE'} MessageType */
